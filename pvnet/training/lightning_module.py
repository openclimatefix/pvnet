...
class PVNetLightningModule(pl.LightningModule):
    ...
    def training_step(self, batch: TensorBatch, batch_idx: int) -> torch.Tensor:
        ...
        bs = y.size(0)
        self.log_dict(losses, on_step=True, on_epoch=True, sync_dist=True, batch_size=bs)
    ...
    def validation_step(self, batch: TensorBatch, batch_idx: int) -> None:
        ...
        bs = y.size(0)
        self.log_dict(losses, on_step=False, on_epoch=True, sync_dist=True, batch_size=bs)
