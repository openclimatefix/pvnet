...
def build_lit_late_fusion_cfg():
    """Factory for PVNetLightningModule + minimal LateFusionModel."""
    def build(*, target_key: str, interval_minutes: int, include_time: bool,
              forecast_minutes: int = 480, history_minutes: int = 60):
        return {
